...
export const config = {
  light: vars({
    ...
    /* Theme Colors */
    "--color-product-blue": "#364D9D",
    "--color-product-blue-light": "#647AC7",
    "--color-product-red-light": "#EE7979",
    "--color-product-gray1": "#1A181B",
    "--color-product-gray2": "#3E3A40",
    "--color-product-gray3": "#5F5B62",
    "--color-product-gray4": "#9F9BA1",
    "--color-product-gray5": "#D9D8DA",
    "--color-product-gray6": "#EDECEE",
    "--color-product-gray7": "#F7F7F8",
  }),
  dark: vars({
